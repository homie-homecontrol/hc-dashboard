...
@Component({
  selector: 'hc-mft-device-attention-widget',
  templateUrl: './mft-device-attention-widget.component.html',
  styleUrls: ['./mft-device-attention-widget.component.scss']
})
export class MftDeviceAttentioWidgetComponent extends WidgetBaseComponent<DeviceAttentionWidget> implements OnInit {
