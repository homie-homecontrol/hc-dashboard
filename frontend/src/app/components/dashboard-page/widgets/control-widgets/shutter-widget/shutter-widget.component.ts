...
@Component({
  selector: 'hc-shutter-widget',
  templateUrl: './shutter-widget.component.html',
  styleUrls: ['./shutter-widget.component.scss']
})
export class ShutterWidgetComponent extends WidgetBaseComponent<RollerShutterWidget> implements OnInit {
