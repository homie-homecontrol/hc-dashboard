...
import { AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, EventEmitter, Inject, Input, NgZone, OnDestroy, OnInit, Optional, Output, ViewChild, ViewEncapsulation } from '@angular/core';
...
export class MftSliderComponent implements ControlValueAccessor, OnDestroy, CanDisable, CanColor, AfterViewInit {
  ...
  private _pointerDown = (event: TouchEvent | MouseEvent) => {
    console.log("_pointerDown", this._isSliding);
